...
const COLUMNS = 4;
const MAX_SCREENSHOTS = 60; // max screenshot to open ai
const SILENCE_DURATION = 2500; //silence detect
const SILENT_THRESHOLD = -30;
 ...
 // convert images into format that we can sent to server
...
export default function Chat() {
  ...
  let { liveStream, ...video } = useMediaRecorder({
    recordScreen: false,
    blopOptions: { type: "video/webm" },
    mediaStreamConstraints: { audio: false, video: true }, // audio using silence recorder
  });
